...
process variant_filtering {
    ...
    bcftools view -f "PASS" -e 'ILEN >= ${params.sv_min_size} | ILEN <= -${params.sv_min_size}' --trim-alt-alleles -o ${variants.getSimpleName()}_PASS.vcf.gz $variants $params.subset_calls
